...
TextTheme defaultText = TextTheme(
  ...
  headline3: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 20),
  headline4: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 24),
  headline5: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 15),
  headline6: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 15),
  subtitle1: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 13),
